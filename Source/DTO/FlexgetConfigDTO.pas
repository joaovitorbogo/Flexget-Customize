...
begin
  ...
  try
    ...
    begin
      LLine := LLines[I];
      if (Trim(LLine) = '') or (Trim(LLine).StartsWith('#')) then Continue;
      ...
      case LLevel of
        ...
        2:
          begin
            ...
            begin
              if (LKey = 'regexp') or (LKey = 'content_size') then
